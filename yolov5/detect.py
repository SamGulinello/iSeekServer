...
class objectDetect:
    ...
    def execute(self, opt, save_img=False):
        ...
        # will be returned containing names of items in pic
        itemsPresent = []
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if save_img or view_img:  # Add bbox to image
                            ...
                            if label[:-5] not in itemsPresent: itemsPresent.append(label[:-5])
